...
DEBUG = False
ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', '.render.com,communiConnect-backend-deploie.onrender.com,localhost,127.0.0.1').split(',')
...
CORS_ALLOWED_ORIGINS = [
    ...
    "https://communiconnect-backend-deploie.onrender.com",
    "http://localhost:3000",
    "http://127.0.0.1:3000",
]

...
class CommuniConnectTester:
    ...
    def test_3_media_upload(self):
        ...
        files = {
            'file': ('test_image_systematic.jpg', img_bytes, 'image/jpeg')
        }
        
        data = {
            'title': 'Image de test systématique',
            'description': 'Test complet de l\'upload'
        }
    ...
    def test_4_create_post_with_media(self, media_id):
        ...
        post_data = {
            "content": "Post de test systématique avec image ! 📸",
            "post_type": "info",
            "is_anonymous": False,
    ...
    def test_5_live_streaming(self):
        ...
        live_data = {
            "title": "Test systématique de live streaming",
            "description": "Test complet du live streaming",
            "content": "Live de test systématique - CommuniConnect !"
        }
    ...
    def test_6_share_post(self, post_id):
        ...
        share_data = {
            "share_type": "share",
            "comment": "Post très intéressant du test systématique !"
        }
        ...
        try:
            ...
            if response.status_code == 201:
                ...
                self.print_info(f"Share ID: {share_id}")
    ...
    def run_all_tests(self):
        ...
        self.print_header("🚀 TEST SYSTÉMATIQUE COMPLET - COMMUNICONNECT")
    ...
    def print_final_summary(self):
        ...
        self.print_header("📊 RÉSUMÉ FINAL DES TESTS")
        ...
        print(f"\n🎯 Évaluation finale:")
        if success_rate >= 90:
            print("🎉 EXCELLENT ! CommuniConnect est presque parfaitement fonctionnel!")
            ...
            print("❌ ATTENTION ! CommuniConnect a des problèmes importants.")
